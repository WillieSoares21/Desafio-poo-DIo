...
public class Main {
    public static void main(String[] args) {
        ...
        curso3.setTitulo("curso android");
        curso3.setDescricao("descrição curso android");
        ...
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Willie:" + devWillie.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos Willie:" + devWillie.getConteudosConcluidos());
